                  ...
                  <tr key={r.id} style={{ borderBottom: '1px solid rgba(13,17,23,0.05)' }}
                    ...
                    <td style={{ padding: '1rem 1.25rem' }}>
                      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                        ...
                        {!isBlocked && <button onClick={() => openEdit(r)} style={{ background: 'transparent', border: '1px solid rgba(13,17,23,0.15)', color: '#6b7280', padding: '0.35rem 0.8rem', borderRadius: 100, cursor: 'pointer', fontSize: '0.78rem', fontWeight: 600, fontFamily: font }}>Editar</button>}
                        {isBlocked && <span style={{ fontSize: '0.75rem', color: '#d1d5db', fontStyle: 'italic' }}>somente leitura</span>}
                      </div>
                    </td>
                  </tr>
                )
