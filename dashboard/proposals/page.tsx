      ...
      {confirmId && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '1rem' }}>
          <div style={{ background: 'white', borderRadius: 20, padding: '2.5rem', width: '100%', maxWidth: 400, textAlign: 'center', boxShadow: '0 24px 64px rgba(0,0,0,0.2)' }}>
            ...
            <h3 style={{ fontFamily: font, fontSize: '1.25rem', fontWeight: 800, marginBottom: '0.5rem', color: '#0d1117' }}>Excluir proposta?</h3>
            <p style={{ color: '#6b7280', fontSize: '0.9rem', marginBottom: '2rem', lineHeight: 1.6 }}>
              Esta ação é permanente. A proposta, seus itens e a conta a receber vinculada serão removidos.
            </p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {proposals.map(p => {
                ...
                return (
                  <tr key={p.id} style={{ borderBottom: '1px solid rgba(13,17,23,0.05)', transition: 'background 0.15s' }}
                    ...
                    <td style={{ padding: '1rem 1.25rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        ...
                        <button
                          ...
                          style={{ background: 'transparent', border: '1px solid rgba(13,17,23,0.12)', cursor: 'pointer', color: '#9ca3af', fontSize: '0.75rem', padding: '0.3rem 0.6rem', borderRadius: 8, fontWeight: 600, fontFamily: font, transition: 'all 0.15s', display: 'flex', alignItems: 'center', gap: '0.3rem' }}
