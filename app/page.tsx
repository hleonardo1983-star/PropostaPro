      ...
      <section style={{ background: '#111827', color: 'white', padding: '6rem 5vw' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: '1.5rem' }}>
            {[
              { name: 'Trial', price: '0', period: '14 dias', desc: 'Período de testes de 14 dias', features: ['Propostas ilimitadas (14d)', '1 usuário', 'Assinatura digital', 'Contas a receber', 'WhatsApp + E-mail', 'Relatórios'], missing: [], featured: false, cta: 'Criar conta grátis' },
