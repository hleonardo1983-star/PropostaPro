      ...
      <section style={{ background: '#111827', color: 'white', padding: '6rem 5vw' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: '1.5rem' }}>
            {[
              { name: 'Free', price: '0', period: 'para sempre', desc: 'Para conhecer a plataforma', features: ['5 propostas/mês', '1 usuário', 'Assinatura digital', 'Contas a receber', 'WhatsApp + E-mail'], missing: ['Relatórios', 'Multi-usuário'], featured: false, cta: 'Criar conta grátis' },
