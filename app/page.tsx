      ...
      <section style={{ background: "#111827", color: "white", padding: "6rem 5vw" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "1.5rem" }}>
            {[
              {
                name: "Free", price: "0", period: "para sempre",
                desc: "Para conhecer a plataforma",
                features: ["5 propostas/mês", "1 usuário", "Assinatura digital", "Contas a receber", "WhatsApp + E-mail"],
                missing: ["Relatórios", "Multi-usuário"],
                featured: false, cta: "Criar conta grátis"
              },
              {
                name: "Starter", price: "49", period: "/mês",
                ...
                missing: ["Multi-usuário"],
                featured: false, cta: "Começar"
              },
              {
                name: "Profissional", price: "99", period: "/mês",
                ...
                missing: [],
                featured: true, cta: "Começar"
              },
              {
                name: "Business", price: "199", period: "/mês",
              ...
              <div key={p.name} style={{ background: p.featured ? "#c8511a" : "rgba(255,255,255,0.05)", border: p.featured ? "none" : "1px solid rgba(255,255,255,0.1)", borderRadius: 20, padding: "2rem", position: "relative" }}>
                ...
                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.5rem", marginBottom: "1.75rem", padding: 0 }}>
                  {p.features.map(f => <li key={f} style={{ fontSize: "0.85rem", display: "flex", alignItems: "center", gap: "0.6rem" }}>
                    <span style={{ color: p.featured ? "rgba(255,255,255,0.9)" : "#059669", fontWeight: 700, fontSize: "0.9rem" }}>✓</span>{f}
                  </li>)}
                  {p.missing.map(f => <li key={f} style={{ fontSize: "0.85rem", display: "flex", alignItems: "center", gap: "0.6rem", opacity: 0.35 }}>
