    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#f8f7f4" }}>
      ...
      <aside style={{ width: 256, background: "#111827", display: "flex", flexDirection: "column", flexShrink: 0, position: "fixed", top: 0, left: 0, bottom: 0 }}>
        ...
        {(userName || companyName) && (
          <div style={{ margin: "0 0.75rem 1.25rem", padding: "0.9rem 1rem", background: "rgba(255,255,255,0.06)", borderRadius: 12, border: "1px solid rgba(255,255,255,0.08)" }}>
            {companyName && <p style={{ fontSize: "0.8rem", fontWeight: 700, color: "white", marginBottom: "0.15rem", letterSpacing: "0.02em" }}>{companyName}</p>}
