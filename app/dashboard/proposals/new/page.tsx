  ...
  return (
    <div style={{ maxWidth: 760 }}>
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontFamily: "'Sora',sans-serif", fontSize: '1.75rem', fontWeight: 700, letterSpacing: '-0.03em', marginBottom: '0.25rem' }}>Nova proposta</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ background: 'white', borderRadius: 16, border: '1px solid rgba(17,24,39,0.08)', padding: '1.25rem 2rem', marginBottom: '1.5rem', display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '1.5rem' }}>
          ...
          <span style={{ fontFamily: "'Sora',sans-serif", fontSize: '2rem', color: '#c8511a', letterSpacing: '-0.03em', fontWeight: 700 }}>{formatCurrency(total)}</span>
        </div>
