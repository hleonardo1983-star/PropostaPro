  ...
  return (
    <div style={{maxWidth:760}}>
      ...
      {(() => {
        ...
        function renderSectionTable({ list, title, icon, subtotal }: { list: any[]; title: string; icon: string; subtotal: number }) {
        ...
        return (
          <>
            {renderSectionTable({ list: services, title: 'Serviços', icon: '🛠️', subtotal: totalServices })}
