    ...
    <div style={{maxWidth:760}}>
      ...
      {showSendModal && (
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1000,padding:"1rem"}}>
          <div style={{background:"white",borderRadius:20,padding:"2.5rem",width:"100%",maxWidth:440}}>
            <h3 style={{fontFamily:"'Instrument Serif',serif",fontSize:"1.5rem",marginBottom:"0.5rem"}}>Enviar proposta</h3>
      ...
      <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",marginBottom:"2rem",flexWrap:"wrap",gap:"1rem"}}>
        <div>
          ...
          <h1 style={{fontFamily:"'Instrument Serif',serif",fontSize:"1.75rem",letterSpacing:"-0.02em",marginBottom:"0.5rem"}}>{proposal.title}</h1>
        ...
        <table style={{width:"100%",borderCollapse:"collapse"}}>
          ...
          <tfoot>
            <tr style={{borderTop:"2px solid rgba(15,14,12,0.1)"}}>
              ...
              <td style={{padding:"1rem 1.5rem",fontSize:"1.1rem",fontWeight:700,textAlign:"right",color:"#c8511a",fontFamily:"'Instrument Serif',serif"}}>{formatCurrency(total)}</td>
            </tr>
          </tfoot>
        </table>
        {proposal.notes && (
