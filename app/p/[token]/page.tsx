...
export default function PublicProposalPage() {
  ...
  if (!proposal) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8f7f4', flexDirection: 'column', gap: '1rem', padding: '2rem', textAlign: 'center' }}>
      ...
      <h1 style={{ fontFamily: "'Sora',sans-serif", fontSize: '1.75rem', fontWeight: 700 }}>Proposta não encontrada</h1>
    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#f8f7f4', fontFamily: "'Inter',system-ui,sans-serif" }}>
        ...
        <div className="no-print" style={{ background: 'white', borderBottom: '1px solid rgba(17,24,39,0.08)', padding: '1rem 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontFamily: "'Sora',sans-serif", fontSize: '1.25rem', fontWeight: 700, letterSpacing: '-0.03em' }}>
        ...
        <div ref={printRef} className="print-area" style={{ maxWidth: 700, margin: '0 auto', padding: '2rem 1.5rem' }}>
          ...
          <div style={{ display: 'none' }} className="print-only">
            <h2 style={{ fontFamily: "'Sora',sans-serif", marginBottom: '0.25rem' }}>{tenant?.name}</h2>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <h1 style={{ fontFamily: "'Sora',sans-serif", fontSize: '1.75rem', fontWeight: 700, letterSpacing: '-0.03em', marginBottom: '0.75rem', color: '#111827' }}>{proposal.title}</h1>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tfoot>
                <tr style={{ borderTop: '2px solid rgba(17,24,39,0.08)', background: '#f9fafb' }}>
                  ...
                  <td style={{ padding: '1rem 1.25rem', fontSize: '1.25rem', fontWeight: 700, textAlign: 'right', color: '#c8511a', fontFamily: "'Sora',sans-serif" }}>{formatCurrency(total)}</td>
                </tr>
              </tfoot>
            </table>
            {proposal.notes && (
          ...
          {!signed ? (
            <div className="no-print" style={{ background: 'white', borderRadius: 16, border: '1.5px solid rgba(17,24,39,0.12)', padding: '2rem' }}>
              <h3 style={{ fontFamily: "'Sora',sans-serif", fontSize: '1.2rem', fontWeight: 700, marginBottom: '0.5rem', color: '#111827' }}>Assinar proposta</h3>
            ...
            <div style={{ background: 'rgba(5,150,105,0.06)', border: '1.5px solid rgba(5,150,105,0.2)', borderRadius: 16, padding: '2rem', textAlign: 'center' }}>
              ...
              <h3 style={{ fontFamily: "'Sora',sans-serif", fontSize: '1.35rem', fontWeight: 700, color: '#065f46', marginBottom: '0.5rem' }}>Proposta aceita!</h3>
